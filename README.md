...
![Project Banner](plots/abalone_banner.jpg)
...
## RAG
<iframe src="https://LoneWolfgang-Abalone-RAG-Demo.hf.space"></iframe>  
- [R Shiny Application](https://example.com)
- [RAG Application](https://example.com)
- [Presentation](https://example.com)

To estimate abalone age using features that are easier to measure, several linear models were evaluated. The best-performing model employed Lasso regularization.
